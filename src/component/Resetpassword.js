    ...
    <div className='w-full h-[80vh] flex flex-col justify-center items-center space-y-3 '>
        <div className='text-center space-y-10 lg:w-1/2 w-full justify-center items-center flex flex-col bg-slate-700 h-[50vh] text-black'>
         <h1 className='text-3xl font-semibold text-white'>Reset Password</h1>
                ...
                <input className='rounded-2xl bg-gray-300 focus:bg-gray-400' type='email' placeholder='email' onChange={(e)=>
                {
                    setEmail(e.target.value)
                }}></input><br/>
                <button className='bg-slate-400 rounded-2xl font-bold py-2 border-black border-2 hover:bg-black hover:text-white duration-500 ease-in lg:w-2/4 lg:mx-auto my-[10%]' type='submit'>Reset Password</button>
