            ...
            return(
                <div className='flex flex-col sm:flex-row w-[80%] justify-center mx-auto h-[80vh] mt-[5%] space-x-[5%]'>
                    ...
                    <div className='w-1.5/5 space-y-[5%]'>
                        ...
                        <p>Or 6 interest-free payments of <span className='font-semibold text-xl'>${item.price/4} </span> with </p>
                        <img src='https://www.forevernew.co.nz/static/version1679452572/frontend/ForeverNew/Base/en_NZ/Laybuy_Laybuy/images/laybuy_logo_grape.svg' className='w-[80px]'></img>
                        </div>
                        <hr></hr>
                        <div className='flex space-x-5'>
                            ...
                            <div>
                                ...
                                return (
                                <span key={index} className="text-xs font-semibold bg-gray-300 rounded-full px-2 py-1 mx-2">
                                    {size}
                                </span>
                                );
